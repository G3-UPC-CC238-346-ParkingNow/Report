...
|   ![alt text](Assets/4.png)   <br>Samuel Elias Molina Asencios<br>                                                     |   Soy estudiante del 7mo ciclo de la carrera de Ingenieria de Software, soy bueno en la resolucion de conflictos y negociacion disfruto de nadar y tocar piano                                                                                                                                                                                                                                                                              |      HTML, CSS, JavaScript, Angular, Vue.js, Python, C++, SQL, MongoDB, MySQL                                                        |
|                                                            |                                                                                                                                                                                                                                                                                |                                                             |
